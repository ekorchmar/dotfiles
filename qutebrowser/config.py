...
tabs = c.colors.tabs
panel_transparency = "BB"
tab_transparency = "DD"

# Tab bar
tabs.bar.bg = c.colors.tabs.bar.bg + panel_transparency
for parity in ["even", "odd"]:
    color = getattr(tabs, parity).bg
    getattr(tabs.pinned, parity).bg = getattr(tabs, parity).bg = (
        color + tab_transparency
    )
...
for mode in [
    ...
    getattr(c.colors.statusbar, mode).bg = (
        getattr(
            c.colors.statusbar,
            mode,
        ).bg
...
## Type: ShellCommand
c.fileselect.folder.command = CMD_PREPEND + [
    "yazi",
    "--cwd-file={}",
]
...
## read instead.
## Type: ShellCommand
c.fileselect.multiple_files.command = CMD_PREPEND + [
    "yazi",
    "--chooser-file={}",
]
...
## Type: ShellCommand
c.fileselect.single_file.command = CMD_PREPEND + [
    "yazi",
    "--chooser-file={}",
]
